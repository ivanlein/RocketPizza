...
import { CartItemSet, addItem, minusItem, removeItem } from "../redux/slises/cartSlice.ts";
...
const CartItem: React.FC<CartItemProps> = ({ id, title, type, size, price, count, src }) => {
    ...
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <button
          ...
          //clsx is a lib for fast optional classname change
